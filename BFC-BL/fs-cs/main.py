...
from model.bfc-bl import AttentiveSqueezeNetwork
...
if __name__ == '__main__':
    ...
    parser.add_argument('--datapath', type=str, default='/root/hai/docker/ifsl-main/fs-cs/dataset', help='Dataset path containing the root dir of pascal & coco')
    parser.add_argument('--method', type=str, default='asnet', choices=['panet', 'pfenet', 'hsnet', 'asnet', 'bfc-bl'], help='FS-CS methods')
    ...
    parser.add_argument('--niter', type=int, default=300, help='Max iterations')
    ...
    parser.add_argument('--nowandb', action='store_true', default=False, help='Flag not to log at wandb')
    parser.add_argument('--eval', action='store_true', default=False, help='Flag to evaluate a model checkpoint')
    parser.add_argument('--weak', action='store_true', default=False, help='Flag to train with cls (weak) labels -- reduce learning rate by 10 times')
    parser.add_argument('--resume', action='store_true',default=True, help='Flag to resume a finished run')
    parser.add_argument('--vis', action='store_true', default=False, help='Flag to visualize. Use with --eval')
